                    ...
                    <div class="flex-col hide-for-medium flex-center">
                        <ul class="nav header-nav header-bottom-nav nav-center nav-line-bottom nav-size-medium nav-spacing-xlarge nav-uppercase">
                            ...
                            <li id="menu-item-6877" class="menu-item {{ request()->routeIs('product.list') || request()->routeIs('product.detail') ? 'active' : '' }}">
                                <a href="{{ route('product.list') }}" class="nav-top-link">PHÂN BÓN HỮU CƠ</a>
                            </li>
        ...
        <div class="sidebar-menu no-scrollbar">
            <ul class="nav nav-sidebar nav-vertical nav-uppercase" data-tab="1">
                ...
                <li class="menu-item {{ request()->routeIs('product.list') || request()->routeIs('product.detail') ? 'active' : '' }}">
                    <a href="{{ route('product.list') }}">PHÂN BÓN HỮU CƠ</a>
                </li>
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-post menu-item-6925">
                    <a href="https://ttpglobal.com.vn/chieu-mo-dai-ly-phan-huu-co-my-cao-cap/">ỨNG TUYỂN ĐẠI LÝ</a>
                </li>
            </ul>
        </div>
    </div>
